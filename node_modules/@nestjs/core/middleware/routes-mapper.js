...
class RoutesMapper {
    ...
    mapRouteToRouteInfo(route) {
        if (shared_utils_1.isString(route)) {
            ...
            return [
                {
                    path: shared_utils_1.addLeadingSlash(route),
        ...
        if (this.isRouteInfo(routePathOrPaths, route)) {
            return [
                {
                    path: shared_utils_1.addLeadingSlash(route.path),
                    method: route.method,
                },
            ];
        }
        ...
        return []
            ...
            return (_a = item.path) === null || _a === void 0 ? void 0 : _a.map(p => {
                ...
                path +=
                    this.normalizeGlobalPath(routePath) + shared_utils_1.addLeadingSlash(p) + '$';
                return {
                    path,
    ...
    normalizeGlobalPath(path) {
        const prefix = shared_utils_1.addLeadingSlash(path);
